...
class Util:
    ...
    def requestFormArgs(modelo, json):
        ...
        args["pessoa"] = ["id","nome","email","registro","logradouro","numero","complemento","cep","ponto_de_referencia","cidade", "estado", "uf", "pais", "rg", "inscricao"]
    ...
    def requestGetArgs(modelo):
        ...
        args["permissao"] = ["id", "modulo"]
    	args["pessoa"] = ["id", "nome", "registro", "email", "cidade", "estado", "uf", "pais", "rg", "inscricao_estadual"]
