...
class Util:
    ...
    def requestGetArgs(modelo):
    	...
    	args["servico"] = ["id","nome"]
    	args["servicoAgendado"] = ["id", "servico_contratado_id", "data_inicio", "data_fim", "recorrente", "executado", "pago", "data_executado_inicio", "data_executado_fim", "animal_id", "servico_id", "cancelado"]
