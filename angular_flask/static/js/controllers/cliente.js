...
angular
	...
	function ClienteController($scope, $http, ClienteFactory) {
		var vm = this;
		vm.telefones = [{ id: 'telefone1' }];
		vm.socials = [];

		vm.clientes = [
			{id: 0, nome: 'André Cadamuro Garcia', email: 'andrecadgarcia@gmail.com', telefone: '+55 14 997033167', endereco: 'Av. Cel. Albino Alves Garcia, 970 - Centro - Bernardino de Campos - SP'},
			{id: 1, nome: 'Aurélio Hiroshi Osawa', email: 'konichiwa@gmail.com', telefone: '+55 42 99765123', endereco: 'Rua Com. Paulo Pinheiro Schimidt, 344 - Uvaranas - Ponta Grossa - PR'},
			{id: 2, nome: 'Cesar Augusto dos Santos', email: 'cesinha_corinthians@gmail.com', telefone: '+55 42 98817431', endereco: 'Rua Papa Pio, 9997 - Jardim Bom Sucesso - Ponta Grossa - PR	'}
		];
	    ...
	    vm.telefones.push({'id':'telefone'+newItemNo});
	  }
	  ...
	  function removeTelefone() {
		...
		function addSocial() {
			...
			vm.socials.push({'id':'social'+newSocialNo});
		}
