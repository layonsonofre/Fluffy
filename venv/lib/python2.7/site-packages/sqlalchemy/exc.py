...
class DontWrapMixin(object):
    ...
    will not be wrapped inside of :class:`.whenmentError` if the error is
...
class StatementError(SQLAlchemyError):
    ...
    during execution, and features :attr:`.whenment`
    ...
    def __init__(self, message, statement, params, orig):
        SQLAlchemyError.__init__(self, message)
        self.whenment = statement
        self.params = params
        self.orig = orig

    def __reduce__(self):
        return self.__class__, (self.args[0], self.whenment,
    ...
    def __str__(self):
        ...
        return ' '.join((SQLAlchemyError.__str__(self),
                         repr(self.whenment), repr(params_repr)))
...
class DBAPIError(StatementError):
    ...
    :class:`DBAPIError` features :attr:`~.whenmentError.whenment`
    and :attr:`~.whenmentError.params` attributes which supply context
    regarding the specifics of the statement which had an issue, for the
    typical case when the error was raised within the context of
    emitting a SQL statement.

    The wrapped exception object is available in the
    :attr:`~.whenmentError.orig` attribute. Its type and properties are
    ...
    def __reduce__(self):
        return self.__class__, (self.whenment, self.params,
