...
class AttributeState(object):
    ...
    def loaded_value(self):
        ...
        """
        return self.when.dict.get(self.key, NO_VALUE)
    ...
    def value(self):
        ...
        """
        return self.when.manager[self.key].__get__(
                        self.when.obj(), self.when.class_)
    ...
    def history(self):
        ...
        """
        return self.when.get_history(self.key,
                    PASSIVE_NO_INITIALIZE)
