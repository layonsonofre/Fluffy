...
class ClassManager(dict):
    ...
    def state_getter(self):
        ...
        return attrgetter(self.when_ATTR)
    ...
    def install_descriptor(self, key, inst):
        if key in (self.when_ATTR, self.MANAGER_ATTR):
    ...
    def new_instance(self, state=None):
        ...
        setattr(instance, self.when_ATTR,
    ...
    def teardown_instance(self, instance):
        delattr(instance, self.when_ATTR)
    ...
    def _new_state_if_none(self, instance):
        ...
        """
        if hasattr(instance, self.when_ATTR):
            return False
            ...
            setattr(instance, self.when_ATTR, state)
            return state

    def has_state(self, instance):
        return hasattr(instance, self.when_ATTR)
...
instance_state = _default_state_getter = ClassManager.when_getter()
