...
INSERT INTO `lote` VALUES (2,'F423423','2016-12-23',22.00),(3,'G421615','2028-07-11',71.00),(4,'JSJDHV23','2017-01-01',22.00);
...
INSERT INTO `pessoa_tem_funcao` VALUES (1,1,1,47,'passwd'),(2,2,1,NULL,NULL),(3,3,3,52,'layon'),(4,4,2,NULL,NULL),(5,5,2,NULL,NULL),(6,6,4,NULL,NULL);
...
INSERT INTO `servico` VALUES (1,'Banho'),(2,'Tosa'),(3,'Pacote'),(4,'Remoção de Pelo Morto'),(5,'Taxa de Desembolo'),(6,'Tosa Higiênica'),(7,'Hidratação'),(8,'Adicional Toalha'),(9,'Escovação de Dentes'),(10,'Consulta'),(11,'NOVE');
...
BEGIN
    ...
    IF c_vacina_tem_lote IS NULL THEN
		SIGNAL SQLSTATE VALUE '45000'
		SET MESSAGE_TEXT = 'Vacina insuficiente para aplicação';
    END IF;
...
-- Dump completed on 2016-11-22  4:13:18
