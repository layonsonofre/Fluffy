...
INSERT INTO `servico_agendado` VALUES (1,28.00,0,'2016-09-06 09:00:00',14,2,1,1,1,NULL,'2016-09-06 10:31:00',3),(2,28.00,0,'2016-09-06 10:00:00',14,3,1,1,1,NULL,'2016-09-06 11:00:00',3),(3,100.00,0,'2016-09-06 10:00:00',62,2,1,1,1,NULL,'2016-09-06 11:00:00',3),(4,50.00,0,'2016-09-12 09:00:00',8,3,2,0,1,NULL,NULL,NULL),(5,20.00,0,'2016-09-12 10:00:00',33,4,2,0,1,NULL,NULL,NULL),(6,36.00,0,'2016-09-12 13:00:00',28,5,2,0,1,NULL,NULL,NULL),(7,7.00,0,'2016-09-12 14:00:00',19,6,2,0,1,NULL,NULL,NULL),(8,171.00,0,'2016-09-15 11:00:00',62,1,3,0,1,NULL,NULL,NULL),(19,10.00,0,'2016-11-12 00:00:00',23,1,8,0,0,NULL,NULL,NULL),(20,10.00,0,'2016-11-12 00:00:00',23,1,8,0,0,NULL,NULL,NULL),(21,10.00,0,'2016-11-12 00:00:00',23,1,8,0,0,NULL,NULL,NULL),(22,10.00,0,'2016-11-12 00:00:00',23,1,8,0,0,NULL,NULL,NULL),(23,10.00,0,'2016-11-12 00:00:00',23,1,8,0,0,NULL,NULL,NULL);
...
BEGIN
		...
		#	SET invalid = invalid + 1;
		#	IF (invalid > 1) THEN
		#		SET error_message = CONCAT(error_message, ", data hora 2");
		#	ELSE
		#		SET error_message = CONCAT(error_message, "data hora 2");
		#	END IF;
		#END IF;
...
INSERT INTO `servico_contratado` VALUES (1,3,156.00,'2016-09-10 02:52:52',1),(2,3,113.00,'2016-09-10 02:52:52',2),(3,3,171.00,'2016-09-10 02:52:52',3),(4,3,0.00,'2016-09-10 02:52:52',4),(8,3,50.00,'2016-11-11 00:03:14',17);
...
INSERT INTO `transacao` VALUES (1,'C','2016-09-10 02:50:39',156.00),(2,'C','2016-09-10 02:50:39',203.00),(3,'C','2016-09-10 02:50:39',201.00),(4,'D','2016-09-10 02:50:39',0.00),(6,'D','2016-11-01 01:31:08',0.00),(7,'C','2016-11-08 08:52:28',0.00),(17,'C','2016-11-11 00:03:14',50.00);
...
BEGIN
    ...
    FROM pessoa p
    INNER JOIN pessoa_tem_funcao as ptf
...
BEGIN
	...
	VALUES
		(p_nome, NOW(), p_email, p_registro, p_logradouro, p_numero, p_complemento, p_cep, p_ponto_de_referencia, p_cidade, p_estado, p_estado_uf, p_pais, p_rg, p_inscricao, p_orgao_expedidor, p_bairro);
...
-- Dump completed on 2016-11-11  0:05:01
