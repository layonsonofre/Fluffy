...
INSERT INTO `pessoa_tem_funcao` VALUES (1,1,1,47,'passwd'),(2,2,1,NULL,NULL),(3,3,3,51,'layon'),(4,4,2,NULL,NULL),(5,5,2,NULL,NULL),(6,6,4,NULL,NULL);
...
INSERT INTO `vacina_tem_lote` VALUES (1,1,2,2),(2,2,3,10),(3,1,4,5);
...
BEGIN
    ...
    SELECT vtl.id INTO c_vacina_tem_lote
    FROM vacina_tem_lote as vtl
    INNER JOIN lote as l ON l.id = vtl.lote_id
    WHERE l.vencimento = (SELECT min(l.vencimento) FROM lote as l);
...
-- Dump completed on 2016-11-22  1:52:10
