...
BEGIN
    ...
    DECLARE porte_tipo INT;     
    DECLARE porte_atual INT;
    ...
    SELECT nome INTO servico 
    FROM tipo_servico 
    WHERE id = NEW.servico_agendado_id;  
    ...
    SELECT porte_id INTO porte_tipo 
	FROM servico_agendado as sa     
    INNER JOIN animal as a ON sa.animal_id = a.id      
    WHERE sa.id = NEW.servico_agendado_id;       
    
    SELECT id INTO porte_atual FROM porte   
    WHERE tamanho_minimo <= NEW.tamanho 
    AND tamanho_maximo >= NEW.tamanho  
    AND peso_minimo <= NEW.peso 
    AND peso_maximo >= NEW.peso   
    and (id%2) = (porte_tipo%2) LIMIT 1;                    
    
	SELECT animal.id INTO animal_id
    FROM animal       
	INNER JOIN servico_agendado as sa                          
    ON sa.animal_id = a.id                         
    WHERE sa.id = NEW.servico_agendado_id;
    
    IF porte_atual IS NOT NULL and porte_atual <> porte_tipo THEN   
		UPDATE animal as a          
        SET a.porte_id = porte_atual          
...
BEGIN
    ...
    SELECT porte_id INTO porte_tipo FROM servico_agendado as sa
    INNER JOIN animal as a ON sa.animal_id = a.id 
    WHERE sa.id = NEW.servico_agendado_id;
	
    SELECT id INTO porte_atual FROM porte 
	WHERE tamanho_minimo <= NEW.tamanho AND tamanho_maximo >= NEW.tamanho
	AND peso_minimo <= NEW.peso AND peso_maximo >= NEW.peso 
	and (id%2) = (porte_tipo%2) LIMIT 1;
...
BEGIN
    ...
    SET money_service = money_service - money;
    SET quantity = quantity + OLD.dose;
...
INSERT INTO `funcao` VALUES (1,'cliente'),(2,'cliente-especial'),(3,'funcionario'),(4,'administrador'),(7,'F'),(8,'FF'),(9,'FFF'),(10,'S'),(11,'função');
...
INSERT INTO `grupo_de_item` VALUES (1,'Petisco'),(2,'Brinquedo Morder'),(3,'Roupa'),(4,'Brinquedo de Pular');
...
INSERT INTO `item_de_venda` VALUES (1,10.00,2,3,1),(2,8.00,1,4,1),(3,4.50,1,11,1),(4,50.00,2,6,2),(5,45.00,3,5,2),(6,10.00,2,3,2),(8,10.00,1,1,9),(9,10.00,2,2,9),(10,10.00,3,3,9),(11,10.00,4,4,9),(12,4.55,1,11,12),(13,3.00,1,9,12),(14,3.00,1,9,12),(15,3.50,1,10,12),(16,10.00,1,1,54),(17,20.00,2,2,54),(18,20.00,1,2,56),(19,12.00,1,12,57),(20,4.55,1,11,57),(21,3.00,1,9,57),(22,4.55,1,11,57);
...
INSERT INTO `lembrete` VALUES (3,'Retirar Lixo','2016-09-15 00:00:00','1',3),(4,'Reunião Sócios','2016-09-15 00:00:00','1',6),(5,'Confirmar Retorno Dolly','2016-11-30 09:00:00','1',3);
...
INSERT INTO `lote` VALUES (2,'F423423','2016-12-23',22.00),(3,'G421615','2028-07-11',71.00),(4,'JSJDHV23','2017-01-01',22.00),(5,'H1N1','2016-11-24',9.00);
...
CREATE TABLE `pedido` (
  ...
  `cliente_id` int(11) NOT NULL COMMENT 'Cliente que realizou o pedido',
...
INSERT INTO `pedido` VALUES (1,22.00,2.00,3,1,3,0),(2,105.00,5.00,2,2,3,0),(3,0.00,0.00,7,1,3,0),(4,0.00,0.00,1,1,3,0),(5,10.00,0.00,1,1,3,0),(9,40.00,0.00,70,1,3,0),(10,22.00,2.00,4,2,3,1),(11,19.55,0.00,88,1,3,1),(12,28.10,0.00,89,1,3,1),(21,0.00,0.00,107,1,3,0),(22,0.00,0.00,108,1,3,0),(23,0.00,0.00,109,1,3,0),(24,0.00,0.00,110,1,3,0),(25,0.00,0.00,111,1,3,0),(26,0.00,0.00,112,1,3,0),(27,0.00,0.00,113,1,3,0),(28,0.00,0.00,114,1,3,0),(29,0.00,0.00,115,1,3,0),(30,0.00,0.00,116,1,3,0),(31,0.00,0.00,117,1,3,0),(32,0.00,0.00,118,1,3,0),(33,0.00,0.00,119,1,3,0),(34,0.00,0.00,120,1,3,0),(35,0.00,0.00,121,1,3,0),(36,0.00,0.00,122,1,3,0),(44,0.00,0.00,130,1,3,0),(54,30.00,0.00,140,1,3,0),(56,20.00,0.00,142,1,3,0),(57,48.20,20.00,175,1,3,1);
...
INSERT INTO `pessoa` VALUES (1,'Andre Cadamuro Garcia','2016-09-10 02:41:21','andre@gmail.com','12766576177','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423630',NULL,NULL,'Alameda'),(2,'Alessandra Bitobrovec','2016-09-10 02:41:21','alessandra@gmail.com','79488137134','Rua das Rosas',13,NULL,'76017920',NULL,'Candeal','Bahia','BA','Brasil',NULL,NULL,NULL,'Jardim'),(3,'Layon de Souza Onofre','2016-09-10 02:41:21','layon@gmail.com','85548552724','Rua Hermito Pascoal',1609,NULL,'16018900',NULL,'Juvenília','Minas Gerais','MG','Brasil',NULL,NULL,NULL,'Vila'),(4,'Cesar dos Santos','2016-09-10 02:41:21','cesar@gmail.com','14076987454','Rua Luterana dos Sétimos Dias',302,'Centro Comercial','01113892',NULL,'Conceição do Castelo','Espírito Santo','ES','Brasil',NULL,NULL,NULL,'Centro'),(5,'Aurelio Hiroshi Ozawa','2016-09-10 02:41:21','aurelio@gmail.com','99285047505','Rua Gerundina',1,NULL,'95768291',NULL,'Jumirim','São Paulo','SP','Brasil',NULL,NULL,NULL,'Parque'),(6,'Janaína Clock','2016-09-10 02:41:21','janaina@gmail.com','50976701081','Rua Estevan Suarez',1,NULL,'11293451',NULL,'Fernandópolis','São Paulo','SP','Brasil',NULL,NULL,NULL,'Centro'),(15,'NOVO NOVO FUNCIONARIO','2016-11-01 01:05:23','novo_func@gmail.com','43743576708','Logradouro',1234,'compl','77987000','Ponto','Mantenópolis','Espírito Santo','ES','Brasil',NULL,NULL,NULL,'Vila'),(16,'Andre Cadamuro Garcia','2016-11-19 21:52:05','andre2@gmail.com','89658888755','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423633',NULL,NULL,'Alameda'),(19,'Nome','2016-11-24 23:30:11','nome2@email.com','41140721526','RUA',1234,'','00000000','','cidade','estado','uf','pais','987654231','',NULL,'Bairro'),(25,'Nome','2016-11-24 23:56:01','nome@email.com','05955183620','RUA',1234,'','00000000','','cidade','estado','uf','pais','1234567','',NULL,'Bairro'),(26,'ANDRE CADAMURO GARCIA','2016-11-28 22:23:56','andrecadgarcia@gmail.com','46588563442','Rua Tiradentes',111,NULL,'84010190',NULL,'Ponta Grossa','Paraná','PR','Brasil','346741349',NULL,'SSP','Centro'),(29,'Andre Cadamuro Garcia','2016-12-07 19:20:16','andreF@gmail.com','09757733806','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423631',NULL,'PR','Alameda'),(30,'Andre Cadamuro Garcia','2016-12-07 19:22:13','andreFH@gmail.com','59482983106','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423632',NULL,'PR','Alameda'),(31,'Andre Cadamuro Garcia','2016-12-07 19:31:27','andreFHK@gmail.com','28475253601','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423634',NULL,'PR','Alameda'),(32,'Andre Cadamuro Garcia','2016-12-08 19:54:27','andre12345@gmail.com','78174088407','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423635',NULL,NULL,'Alameda'),(33,'Andre Cadamuro Garcia','2016-12-08 19:55:37','andre1234@gmail.com','73431428797','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423636',NULL,NULL,'Alameda'),(34,'Andre Cadamuro Garcia','2016-12-08 19:58:22','andre123456@gmail.com','87248364002','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423637',NULL,NULL,'Alameda'),(35,'Andre Cadamuro Garcia','2016-12-08 20:01:06','andre1234567@gmail.com','22370781300','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423638',NULL,NULL,'Alameda'),(38,'Andre Cadamuro Garcia','2016-12-08 20:08:03','andre12345678@gmail.com','17079266114','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423639',NULL,NULL,'Alameda'),(39,'Andre Cadamuro Garcia','2016-12-08 20:14:27','andre123456789@gmail.com','62532967447','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423640',NULL,NULL,'Alameda'),(40,'Andre Cadamuro Garcia','2016-12-08 20:16:10','andre1234567890@gmail.com','34171368308','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423641',NULL,NULL,'Alameda'),(41,'Andre Cadamuro Garcia','2016-12-08 23:07:26','andres@gmail.com','42391688725','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423650',NULL,NULL,'Alameda'),(42,'Andre Cadamuro Garcia','2016-12-08 23:12:18','andres1@gmail.com','39774453247','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423651',NULL,NULL,'Alameda'),(43,'Andre Cadamuro Garcia','2016-12-08 23:19:27','andres2@gmail.com','87114588364','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423652',NULL,NULL,'Alameda'),(44,'Andre Cadamuro Garcia','2016-12-08 23:20:54','andres3@gmail.com','55116694402','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423653',NULL,NULL,'Alameda'),(45,'Andre Cadamuro Garcia','2016-12-08 23:23:07','andres4@gmail.com','32249514518','Rua Jo?e Luis Lopez',910,'Apartamento 31','33009440','Farmácia','Ivaiporã','Paraná','PR','Brasil','496423654',NULL,NULL,'Alameda'),(46,'TESTE','2016-12-12 22:04:45','andrecadgarcia@hotmail.com','37334088700','Rua do Rosário',1111,NULL,'84010150',NULL,'Ponta Grossa','Paraná','PR','Brasil','4964236388',NULL,'SSP','Centro'),(57,'Lavínia Eduarda Laís Gomes','2016-12-13 00:31:17','lavinia2.eduarda.gomes@unidademovel.com','89915299257','Rua Marcassita',249,'Apartamento 31','84021350',NULL,'Ponta Grossa','Paraná','PR','Brasil','137091060',NULL,'SSP/SP','Colônia Dona Luiza');
...
INSERT INTO `pessoa_tem_funcao` VALUES (1,1,1,47,'passwd'),(2,2,1,NULL,NULL),(3,3,3,84,'45187686033c17632b49fed0d6a2d74d'),(4,4,2,NULL,NULL),(5,5,2,NULL,NULL),(6,6,4,NULL,NULL),(7,19,3,NULL,'1234567890'),(13,25,1,NULL,NULL),(14,26,1,NULL,NULL),(15,29,4,NULL,'11234'),(16,30,4,NULL,'11234'),(17,31,4,NULL,'11234'),(18,32,1,NULL,NULL),(19,33,1,NULL,NULL),(20,34,1,NULL,NULL),(21,35,1,NULL,NULL),(22,38,3,NULL,'1234'),(23,39,3,NULL,'1234'),(24,40,4,NULL,'1234'),(25,41,1,NULL,NULL),(26,42,1,NULL,NULL),(27,43,3,NULL,'112111'),(28,44,3,NULL,'112111'),(29,45,4,NULL,'112111'),(30,46,4,77,'09565c5b6cd7fe85e482be993b78956c'),(41,57,2,NULL,NULL);
...
INSERT INTO `pessoa_tem_permissao` VALUES (1,3,1),(2,3,2),(3,3,3),(5,3,4),(6,7,1),(7,7,2),(8,7,3),(9,17,1),(10,17,2),(11,17,3),(12,17,4),(13,23,1),(14,23,2),(15,24,1),(16,24,2),(17,24,3),(18,24,4),(19,28,1),(20,28,2),(21,29,1),(22,29,2),(23,29,3),(24,29,4),(25,30,1),(26,30,2),(27,30,3),(28,30,4);
...
INSERT INTO `pessoa_tem_rede_social` VALUES (1,'Andre Garcia',1,1),(2,'(22)99831123',2,1),(3,'Alessandra Bitobrovec',1,2),(4,'Cesar Santos',1,4),(7,'perfil1',1,25),(8,'perfil2',2,25),(9,'05542999984562',2,26),(10,'ANDRE',1,35),(11,'ANDRE',2,35),(12,'ANDRE',1,41),(13,'ANDRE',2,41),(14,'ANDRE',1,42),(15,'ANDRE',2,42);
...
INSERT INTO `servico` VALUES (1,'Banho'),(2,'Tosa'),(3,'Pacote'),(4,'Remoção de Pelo Morto'),(5,'Taxa de Desembolo'),(6,'Tosa Higiênica'),(7,'Hidratação'),(8,'Adicional Toalha'),(9,'Escovação de Dentes'),(10,'Consulta'),(11,'TaxiDog');
...
INSERT INTO `servico_agendado` VALUES (1,28.00,0,'2016-09-06 09:00:00',14,2,1,1,1,NULL,'2016-09-06 10:31:00',3,0),(2,28.00,0,'2016-09-06 10:00:00',14,3,1,1,1,NULL,'2016-09-06 11:00:00',3,0),(3,1000.00,0,'2016-09-06 10:00:00',62,2,1,1,1,NULL,'2016-09-06 11:00:00',3,1),(4,50.00,0,'2016-09-12 09:00:00',8,3,2,0,1,NULL,NULL,NULL,0),(5,20.00,0,'2016-09-12 10:00:00',33,4,2,0,1,NULL,NULL,NULL,0),(6,36.00,0,'2016-09-12 13:00:00',28,5,2,0,1,NULL,NULL,NULL,0),(7,7.00,0,'2016-09-12 14:00:00',19,6,2,0,1,NULL,NULL,NULL,0),(8,171.00,0,'2016-09-15 11:00:00',62,1,3,0,1,NULL,NULL,NULL,0),(19,10.00,0,'2016-11-12 00:00:00',23,1,8,0,0,NULL,NULL,NULL,0),(20,10.00,0,'2016-11-12 00:00:00',23,1,8,0,0,NULL,NULL,NULL,0),(21,10.00,0,'2016-11-12 00:00:00',23,1,8,0,0,NULL,NULL,NULL,0),(24,55.00,0,'2016-11-15 02:00:00',22,1,55,0,0,'blablabla',NULL,NULL,0),(25,55.00,0,'2016-11-15 09:00:00',22,1,56,0,0,NULL,NULL,NULL,0),(27,31.00,0,'2016-11-21 00:00:00',21,1,61,0,0,'sdasadsad',NULL,NULL,0),(28,50.00,1,'2016-11-25 13:00:00',27,1,62,1,1,NULL,NULL,NULL,0),(29,31.00,1,'2016-12-01 04:00:00',26,1,64,1,1,NULL,NULL,NULL,0),(30,50.00,0,'2016-11-30 13:00:00',62,2,63,0,0,'',NULL,NULL,0),(31,50.00,1,'2016-12-01 02:00:00',62,4,65,1,1,NULL,NULL,NULL,0),(32,171.00,1,'2016-11-30 09:00:00',62,1,66,1,1,NULL,NULL,NULL,0),(33,171.00,1,'2016-11-30 09:00:00',21,1,66,1,1,NULL,NULL,NULL,0),(34,10.00,0,'2016-12-19 09:00:00',21,1,87,0,0,NULL,NULL,NULL,0),(35,10.00,0,'2016-12-19 09:00:00',17,2,87,0,0,NULL,NULL,NULL,0),(36,10.00,0,'2016-12-19 09:00:00',21,1,88,0,0,NULL,NULL,NULL,0),(37,10.00,0,'2016-12-19 09:00:00',17,2,88,0,0,NULL,NULL,NULL,0),(38,10.00,0,'2016-12-19 09:00:00',21,1,89,0,0,NULL,NULL,NULL,0),(39,10.00,0,'2016-12-01 09:00:00',17,2,89,0,0,NULL,NULL,NULL,0),(40,10.00,0,'2016-12-19 09:00:00',21,1,90,0,0,NULL,NULL,NULL,0),(41,55.00,0,'2016-12-12 02:00:00',22,1,93,0,1,NULL,NULL,NULL,0),(42,28.00,0,'2016-12-12 20:00:00',14,2,97,0,1,NULL,NULL,NULL,0),(43,55.00,0,'2016-12-12 21:00:00',15,2,97,0,1,NULL,NULL,NULL,0),(44,120.00,0,'2016-12-12 16:00:00',30,4,98,0,0,NULL,NULL,NULL,0),(45,7.00,0,'2016-12-12 14:00:00',17,9,99,0,0,NULL,NULL,NULL,0),(46,30.00,0,'2016-12-13 10:00:00',63,1,103,0,1,NULL,NULL,NULL,0),(47,31.00,0,'2016-12-14 11:00:00',21,1,104,0,1,NULL,NULL,NULL,0),(48,30.00,0,'2016-12-14 10:00:00',63,1,105,0,0,NULL,NULL,NULL,0),(49,31.00,0,'2016-12-14 10:00:00',21,1,105,0,0,NULL,NULL,NULL,0);
...
BEGIN
    ...
    IF (NEW.preco - (SELECT stp.preco
    FROM servico_tem_porte stp
    WHERE stp.id = NEW.servico_tem_porte_id)) > 0 THEN
		SET invalid = 1;
			SET error_message = CONCAT(error_message, "\nPreço não pode ser maior que o sugerido.");
    END IF;
	
    IF ABS(NEW.preco - (SELECT stp.preco
    FROM servico_tem_porte stp
    WHERE stp.id = NEW.servico_tem_porte_id)) > (NEW.preco/10) THEN
		SET invalid = 1;
			SET error_message = CONCAT(error_message, "\nDesconto não pode ser maior que 10%.");
    END IF;
...
BEGIN
    ...
    DECLARE mensagem_cancelamento VARCHAR(100);
        
	SET invalid = 0;
	SET error_message = "";
    SET mensagem_cancelamento = "";
    ...
    IF OLD.cancelado = 1 AND NEW.cancelado = 0 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nImpossível reativar agendamento cancelado.");
    END IF;
    
    IF OLD.cancelado = 1 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nImpossível alterar agendamento cancelado.");
    END IF;
    
    IF OLD.executado = 1 AND OLD.pago = 1 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nImpossível alterar agendamento finalizado.");
    END IF;
    ...
    IF OLD.cancelado = 0 AND NEW.cancelado = 1 THEN
        INSERT INTO transacao(tipo, data_hora, valor, comentario) VALUES('D', NOW(), OLD.preco, "Devolução de valor referente ao cancelamento");
	END IF;
    
    IF OLD.cancelado = 0 AND NEW.cancelado = 0 THEN
        SELECT sc.preco INTO money FROM servico_contratado sc WHERE sc.id = NEW.servico_contratado_id;
...
',0.00,NULL),(121,'C','2016-12-08 23:57:35',0.00,NULL),(122,'C','2016-12-08 23:58:02',0.00,NULL),(130,'C','2016-12-09 00:20:57',0.00,NULL),(140,'C','2016-12-09 00:33:38',30.00,NULL),(142,'C','2016-12-09 00:34:07',20.00,NULL),(144,'C','2016-12-09 00:46:53',0.00,NULL),(145,'C','2016-12-09 00:47:43',0.00,NULL),(146,'C','2016-12-09 00:52:24',0.00,NULL),(147,'C','2016-12-09 00:52:26',0.00,NULL),(148,'C','2016-12-09 00:55:31',0.00,NULL),(149,'C','2016-12-09 00:56:46',0.00,NULL),(150,'C','2016-12-09 00:57:56',0.00,NULL),(162,'C','2016-12-09 01:14:04',20.00,NULL),(163,'C','2016-12-09 01:14:27',20.00,NULL),(164,'C','2016-12-09 01:14:47',20.00,NULL),(165,'C','2016-12-09 01:15:52',10.00,NULL),(168,'C','2016-12-12 00:19:26',55.00,NULL),(172,'C','2016-12-12 00:26:11',83.00,NULL),(173,'C','2016-12-12 00:33:36',120.00,NULL),(174,'C','2016-12-12 00:34:33',7.00,NULL),(175,'C','2016-12-12 00:37:14',28.20,NULL),(179,'C','2016-12-12 20:52:18',30.00,NULL),(180,'C','2016-12-13 01:35:52',31.00,NULL),(181,'C','2016-12-13 05:33:27',61.00,NULL);
...
INSERT INTO `vacina` VALUES (1,'V8',4,12),(2,'Gripe Canina',10,36);
...
INSERT INTO `vacina_tem_lote` VALUES (1,1,2,8),(2,2,3,10),(3,1,4,9);
...
BEGIN
	...
	IF p_id IS NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nNecessário informar código de registro.");
    END IF;
    ...
    IF c_servico_agendado = 0 AND p_servico_agendado_id IS NOT NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nServico Agendado não cadastrado."); 
    END IF;
...
BEGIN
    ...
    IF c_animal_tem_restricao1 = 0 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nAnimal Não possui essa restrição."); 
    END IF;
...
BEGIN
    ...
    IF c_servico_agendado = 0 AND p_servico_agendado_id IS NOT NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nServiço Agendado não cadastrado.");
    END IF;
...
BEGIN
	...
	IF c_token > 0 AND p_token IS NOT NULL THEN
        SET invalid = 1;
	...
	IF c_refresh_token > 0 AND p_refresh_token IS NOT NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nRefresh Token já está em uso.");
	END IF;
...
BEGIN
    ...
    IF 	p_valor IS NULL AND p_desconto IS NULL AND p_transacao_id IS NULL 
		AND p_cliente_id IS NULL AND p_funcionario_id IS NULL AND p_pago IS NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nNenhuma informação foi alterada."); 
	END IF;
...
BEGIN
    ...
    IF c_email_proprio IS NOT NULL AND
		...
		IF c_email > 0 AND p_email IS NOT NULL THEN
			SET invalid = 1;
			SET error_message = CONCAT(error_message, "\nEmail já está sendo utilizado por outra pessoa.");
		END IF;
	END IF;
    ...
    IF c_registro_proprio IS NOT NULL AND
		...
		IF c_registro > 0 AND p_registro IS NOT NULL THEN
			SET invalid = 1;
			SET error_message = CONCAT(error_message, "\nRegistro já está sendo utilizado por outra pessoa.");
		END IF;
	END IF;
    ...
    IF c_rg_proprio IS NOT NULL AND
		...
		IF c_rg > 0 AND p_rg IS NOT NULL THEN
			SET invalid = 1;
			SET error_message = CONCAT(error_message, "\nRG já está sendo utilizado por outra pessoa.");
		END IF;
	END IF;
...
BEGIN
	...
	IF c_pessoa_tem_funcao1 = 0 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nNenhuma Função atribuída à Pessoa.");
	END IF;
    ...
    IF p_pessoa_id IS NULL AND p_funcao_id IS NULL 
    AND p_password IS NULL AND p_oauth_id IS NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nNenhuma informação foi alterada."); 
	END IF;
...
BEGIN
	...
	IF c_pessoa_tem_permissoes1 = 0 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nPessoa não possui essa restrição.");
	END IF;
...
BEGIN
    ...
    IF c_nome_proprio IS NOT NULL AND
		...
		IF c_nome > 0 AND p_nome IS NOT NULL THEN
			SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nPorte já cadastrado.");
		END IF;
	END IF;
...
BEGIN
	...
	IF c_servico_contratado = 0 AND p_servico_contratado_id IS NOT NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nServiço Contratado não cadastrado.");
	END IF;
    ...
    AND p_data_hora_executado IS NULL AND p_funcionario_executa_id IS NULL 
    AND p_cancelado IS NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nNenhuma informação foi alterada."); 
	END IF;
...
BEGIN
	...
	IF c_vacina_tem_lote1 = 0 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nLote não atribuído à essa Vacina.");
	END IF;
...
BEGIN
    ...
    IF c_animal = 0 THEN
		SIGNAL SQLSTATE VALUE '45000'
		SET MESSAGE_TEXT = 'Animal não cadastrado';SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nAnimal não cadastrado."); 
    END IF;
...
BEGIN
    ...
    IF c_pessoa_tem_rede_social = 0 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nPessoa não possui essa Rede Social."); 
    END IF;
...
BEGIN
    ...
    DECLARE sum_vendas_totais INT;
    DECLARE sum_vendas_pagas INT;
    DECLARE sum_servicos_totais INT;
    DECLARE sum_servicos_realizados INT;
    DECLARE sum_servicos_pagos INT;
    
    SELECT SUM(t.valor) INTO sum_c FROM transacao as t 
		WHERE tipo = 'C'
        AND ((p_data_inicio is null and p_data_fim is null) OR (t.data_hora between p_data_inicio and p_data_fim));
    IF sum_c IS NULL THEN
		SET sum_c = 0;
    END IF;
    
    SELECT SUM(t.valor) INTO sum_d FROM transacao as t 
		WHERE tipo = 'D'
        AND ((p_data_inicio is null and p_data_fim is null) OR (t.data_hora between p_data_inicio and p_data_fim));
	IF sum_d IS NULL THEN
		SET sum_d = 0;
    END IF;
    
    SELECT COUNT(*) INTO sum_vendas_totais FROM pedido as p
		INNER JOIN transacao as t ON t.id = p.transacao_id
        WHERE ((p_data_inicio is null and p_data_fim is null) OR (t.data_hora between p_data_inicio and p_data_fim))
        AND t.tipo = 'C';
	IF sum_vendas_totais IS NULL THEN
		SET sum_vendas_totais = 0;
    END IF;
    
    SELECT COUNT(*) INTO sum_vendas_pagas FROM pedido as p
		INNER JOIN transacao as t ON t.id = p.transacao_id
        WHERE ((p_data_inicio is null and p_data_fim is null) OR (t.data_hora between p_data_inicio and p_data_fim))
        AND t.tipo = 'C'
        AND p.pago = 1;
	IF sum_vendas_pagas IS NULL THEN
		SET sum_vendas_pagas = 0;
    END IF;
        
	SELECT COUNT(*) INTO sum_servicos_totais FROM servico_agendado as sa
        WHERE ((p_data_inicio is null and p_data_fim is null) OR (sa.data_hora between p_data_inicio and p_data_fim));
	IF sum_servicos_totais IS NULL THEN
		SET sum_servicos_totais = 0;
    END IF;
    
    SELECT COUNT(*) INTO sum_servicos_realizados FROM servico_agendado as sa
        WHERE ((p_data_inicio is null and p_data_fim is null) OR (sa.data_hora between p_data_inicio and p_data_fim))
        AND sa.executado = 1;
	IF sum_servicos_realizados IS NULL THEN
		SET sum_servicos_realizados = 0;
    END IF;
        
	SELECT COUNT(*) INTO sum_servicos_pagos FROM servico_agendado as sa
        WHERE ((p_data_inicio is null and p_data_fim is null) OR (sa.data_hora between p_data_inicio and p_data_fim))
        AND sa.pago = 1;
	IF sum_servicos_pagos IS NULL THEN
		SET sum_servicos_pagos = 0;
    END IF;
    
	SELECT sum_c as soma_credito, sum_d as soma_debito, sum_c-sum_d as caixa,
		sum_vendas_totais as totais_vendas, sum_vendas_pagas as vendas_pagas, sum_servicos_totais as totais_servicos, 
        sum_servicos_realizados as servicos_realizados, sum_servicos_pagos as servicos_pagos,
...
/*!50003 SET sql_mode              = 'NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getLog`(
	IN p_id INT
)
BEGIN
	SELECT * FROM log WHERE id = p_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
	SELECT o.id, o.data_hora, o.vencimento, o.token, o.refresh_token, CAST(TIMEDIFF(o.vencimento, NOW()) * 24 * 60 as SIGNED)
    FROM oauth o
    WHERE 1 = 1
...
BEGIN
	SELECT p.id, p.valor, p.desconto, ptf1.id as pessoa_tem_funcao_cliente_id, 
    pe1.id as pessoa_cliente_id, pe1.nome as cliente, ptf2.id as pessoa_tem_funcao_funcionario_id, 
    pe2.id as pessoa_funcionario_id, pe2.nome as funcionario, p.pago as pago
    FROM pedido p
...
BEGIN
	SELECT v.id, v.nome, v.dose as dose, v.intervalo
    FROM vacina v
    WHERE 1 = 1
...
BEGIN
    ...
    IF p_peso IS NULL OR p_tamanho IS NULL OR p_temperatura IS NULL OR p_servico_agendado_id IS NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nImpossível inserir campos vazios.");
	END IF;
...
BEGIN
    ...
    IF c_animal_tem_restricao > 0 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nRestrição ja atribuída à Animal.");
    END IF;
...
BEGIN
    ...
    SELECT vtl.id, min(l.vencimento) INTO c_vacina_tem_lote, c_vencimento
    FROM vacina_tem_lote as vtl
    INNER JOIN lote as l ON l.id = vtl.lote_id
    WHERE vtl.vacina_id = p_vacina_id
    AND vtl.quantidade >= p_dose;
    IF c_vacina_tem_lote IS NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nVacina insuficiente para aplicação.");
    END IF;
	...
	VALUES
		(p_data_hora, p_aplicado, p_dose, c_vacina_tem_lote, p_servico_agendado_id);
...
BEGIN
    ...
    IF 	p_valor IS NULL OR p_desconto IS NULL OR p_transacao_id IS NULL OR 
		p_cliente_id IS NULL OR p_funcionario_id IS NULL OR p_pago IS NULL THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nImpossível inserir campos vazios.");
	END IF;
	...
	INSERT INTO pedido
		(valor, desconto, transacao_id, cliente_id, funcionario_id, pago)
	VALUES
		(p_valor, p_desconto, p_transacao_id, p_cliente_id, p_funcionario_id, p_pago);
...
BEGIN
	...
	IF c_pessoa_tem_permissoes > 0 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nPermissão já atribuída à Pessoa.");
	END IF;
...
BEGIN
    ...
    IF c_pessoa_tem_rede_social > 0 THEN
		SET invalid = 1;
		SET error_message = CONCAT(error_message, "\nRede Social ja atribuída à Pessoa.");
    END IF;
...
BEGIN
    ...
    IF c_servico_tem_porte IS NULL THEN
		SELECT stp.id INTO c_servico_tem_porte
		FROM servico_tem_porte as stp
		INNER JOIN porte as p
		ON stp.porte_id = p.id
...
-- Dump completed on 2016-12-13  5:49:46
