...
INSERT INTO `pessoa` VALUES (1,'Andre Cadamuro Garcia','2016-09-10 02:41:21','andre@gmail.com','12766576177','Rua Jośe Luis Lopez',910,'Apartamento 31','33009440','Farmácia',2948),(2,'Alessandra Bitobrovec','2016-09-10 02:41:21','alessandra@gmail.com','79488137134','Rua das Rosas',13,NULL,'76017920',NULL,357),(3,'Layon de Souza Onofre','2016-09-10 02:41:21','layon@gmail.com','85548552724','Rua Hermito Pascoal',1609,NULL,'16018900',NULL,1986),(4,'Cesar dos Santos','2016-09-10 02:41:21','cesar@gmail.com','14076987454','Rua Luterana dos Sétimos Dias',302,'Centro Comercial','01113892',NULL,21),(5,'Aurelio Hiroshi Ozawa','2016-09-10 02:41:21','aurelio@gmail.com','99285047505','Rua Gerundina',1,NULL,'95768291',NULL,5000),(6,'Janaína Clock','2016-09-10 02:41:21','janaina@gmail.com','50976701081','Rua Estevan Suarez',1,NULL,'11293451',NULL,4886),(15,'NOVO NOVO FUNCIONARIO','2016-11-01 01:05:23','novo_func@gmail.com','43743576708','Logradouro',1234,'compl','77987000','Ponto',44);
...
BEGIN
    ...
    IF c_estado = 0 AND p_estado_id IS NOT NULL THEN
		SIGNAL SQLSTATE VALUE '45000'
    ...
    UPDATE cidade
       SET nome = CASE WHEN p_nome IS NULL THEN nome ELSE p_nome END
         , estado_id = CASE WHEN p_estado_id IS NULL THEN estado_id ELSE p_estado_id END
	WHERE id = p_id;
...
BEGIN
    ...
    IF c_pais = 0 AND p_pais_id IS NOT NULL THEN
		SIGNAL SQLSTATE VALUE '45000'
	...
	UPDATE estado
       SET nome = CASE WHEN p_nome IS NULL THEN nome ELSE p_nome END
         ...
         , pais_id = CASE WHEN p_pais_id IS NULL THEN pais_id ELSE p_pais_id END
	 WHERE id = p_id;
...
BEGIN
	SELECT e.id, e.nome as estado, e.uf, p.id as pais_id, p.nome as pais
		...
		AND ((p_id is null) or (e.id = p_id))
		AND ((p_nome is null) or (e.nome like concat('%', p_nome, '%')))
		AND ((p_uf is null) or (e.uf like p_uf))
		AND ((p_pais_id is null) or (e.pais_id = p_pais_id));
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
    ...
    IF p_nome IS NULL OR p_email IS NULL OR p_registro IS NULL OR p_logradouro IS NULL OR p_numero IS NULL OR p_cep IS NULL OR p_cidade_id IS NULL THEN
        SIGNAL SQLSTATE VALUE '45000'
		SET MESSAGE_TEXT = 'Impossível inserir campo nulo';
	END IF;
...
-- Dump completed on 2016-11-02  1:31:49
